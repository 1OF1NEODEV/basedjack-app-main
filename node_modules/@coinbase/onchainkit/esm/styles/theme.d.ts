...
export declare const pressable: {
    readonly default: "cursor-pointer ock-bg-default active:ock-bg-default-active hover:bg-[var(--ock-bg-default-hover)]";
    readonly alternate: "cursor-pointer ock-bg-alternate active:ock-bg-alternate-active hover:[var(--ock-bg-alternate-hover)]";
    readonly inverse: "cursor-pointer ock-bg-inverse active:ock-bg-inverse-active hover:bg-[var(--ock-bg-inverse-hover)]";
    readonly primary: "cursor-pointer ock-bg-primary active:ock-bg-primary-active hover:bg-[var(--ock-bg-primary-hover)]";
    readonly secondary: "cursor-pointer ock-bg-secondary active:ock-bg-secondary-active hover:bg-[var(--ock-bg-secondary-hover)]";
    readonly coinbaseBranding: "cursor-pointer bg-[#0052FF] active:ock-bg-secondary-active hover:bg-[#0045D8]";
